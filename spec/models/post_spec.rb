...
RSpec.describe Post, type: :model do
  ...
  describe '#five_most_recent_comments' do
    before do
      @comment1 = Comment.create(text: 'comment 1', author: user, post:)
      @comment2 = Comment.create(text: 'comment 2', author: user, post:)
      @comment3 = Comment.create(text: 'comment 3', author: user, post:)
      @comment4 = Comment.create(text: 'comment 4', author: user, post:)
      @comment5 = Comment.create(text: 'comment 5', author: user, post:)
      @comment6 = Comment.create(text: 'comment 6', author: user, post:)
    end
